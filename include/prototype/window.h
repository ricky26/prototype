...
namespace prototype
{
	...
	public:
		...
		PROTOTYPE_INLINE netlib::delegate &on_resized() { return mResized; }
		PROTOTYPE_INLINE netlib::delegate &on_painted() { return mPainted; }
		
		PROTOTYPE_INLINE netlib::delegate &on_key_down() { return mKeyDown; }
		PROTOTYPE_INLINE netlib::delegate &on_key_pressed() { return mKeyPressed; }
		PROTOTYPE_INLINE netlib::delegate &on_key_typed() { return mKeyTyped; }
		PROTOTYPE_INLINE netlib::delegate &on_key_up() { return mKeyUp; }
		
		PROTOTYPE_INLINE netlib::delegate &on_mouse_move() { return mMouseMove; }
		PROTOTYPE_INLINE netlib::delegate &on_mouse_down() { return mMouseDown; }
		PROTOTYPE_INLINE netlib::delegate &on_mouse_double_click() { return mMouseDblClick; }
		PROTOTYPE_INLINE netlib::delegate &on_mouse_up() { return mMouseUp; }
	...
	private:
		...
		delegate mKeyDown;
		delegate mKeyPressed;
		delegate mKeyTyped;
		delegate mKeyUp;

		delegate mMouseMove;
		delegate mMouseDown;
		delegate mMouseDblClick;
		delegate mMouseUp;
	};
